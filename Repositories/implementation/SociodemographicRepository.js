...
exports.SociodemographicRepository = void 0;
...
class SociodemographicRepository {
    GetAll() {
    ...
    Insert(entity) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve) => {
                DatabaseContext_1.default.query(postQuery, [entity.name], (err, rows) => {
                    if (err)
                        throw err;
...
exports.SociodemographicRepository = SociodemographicRepository;
