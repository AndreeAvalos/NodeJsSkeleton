...
exports.ClientSociodemographicRepository = void 0;
...
class ClientSociodemographicRepository {
    GetAll() {
    ...
    Insert(entity) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve) => {
                DatabaseContext_1.default.query(postQuery, [entity.client, entity.sociodemographic], (err, rows) => {
                    if (err)
                        throw err;
...
exports.ClientSociodemographicRepository = ClientSociodemographicRepository;
