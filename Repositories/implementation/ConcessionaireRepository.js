...
exports.ConcessionaireRepository = void 0;
...
class ConcessionaireRepository {
    ...
    Insert(entity) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve) => {
                DatabaseContext_1.default.query(postQuery, [entity.name, entity.address], (err, rows) => {
                    if (err)
                        throw err;
...
exports.ConcessionaireRepository = ConcessionaireRepository;
